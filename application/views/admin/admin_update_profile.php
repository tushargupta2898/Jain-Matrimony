...
<?php
  $full_detail_id=$this->uri->segment(3);
  $profile_data=$this->db->get_where("user_detail",array('user_id' =>$full_detail_id))->row();
   ...
   <?php include_once("admin_nav.php");?>
    ...
    <div id="page-wrapper">
        ...
        <div class="panel-body">
                ...
                <div class="col-md-4"><input type="email" class="input-sm form-control" name="email" placeholder="Enter Email" required="required" value="<?php echo $email; ?>" readonly="readonly" />
                </div>
              </div>
                   ...
                   <textarea class="form-control" name="about_me" id="about_me" placeholder="Enter About Me"><?php echo $about_me;?></textarea>
                      ...
                      <div class="panel panel-danger">
                        ...
                        <div class="panel panel-footer">
                            <button type="button" class="btn btn-warning" onclick="update_profile();"><i class="fa fa-save"></i>&nbsp;&nbsp;Update</button>
                        </div>
                      </div>
                </div>
                 </form>
